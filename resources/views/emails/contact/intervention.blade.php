            ...
            <div class="row">
                <div class="col-lg-6 mx-auto">
                    <header class="text-center pb-5">
                        ...
                        <p>Vous avez recu un message de demande d'intervention
                            .<br>Nom:{{$intervention['first_name']}}<br>Email:{{$intervention['email']}}<br>Number:{{$intervention['number']}}</p>
                    </header>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 mx-auto">
                    ...
                    <blockquote class="blockquote blockquote-custom bg-white p-5 shadow rounded">
                        ...
                        <p class="mb-0 mt-2 font-italic">Méssage:{{$intervention['message']}}</p>
