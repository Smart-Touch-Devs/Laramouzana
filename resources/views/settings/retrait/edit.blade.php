...
<div class="grid grid-cols-12 gap-6 mt-5">
    ...
    <div class="intro-y col-span-12 lg:col-span-4">
        <form action="{{ route('retrait_percentage.update',$retrait_percentage->id) }}" method="post" >
            @csrf
            @method('PATCH')
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input type="text" class="input w-full border mt-2" name="deposit_percentage" value="{{ $retrait_percentage->retrait_percentage }}">
