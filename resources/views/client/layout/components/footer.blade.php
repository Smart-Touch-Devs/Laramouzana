                ...
                <div class="col-lg-5">
                    ...
                    <div class="mb-4">
                        <div class="row no-gutters">
                            ...
                            <div class="col pl-3">
                                <div class="font-size-13 font-weight-light">Vous avez des questions ? Appelez-nous
                                    24h/24 et 7j/7 !</div>
                                <a href="tel:+226 02050607" class="font-size-20 text-gray-90">(+223) 58478958, </a><a
                                    href="tel:+0600874548" class="font-size-20 text-gray-90">(+225) 87458548</a>
                            </div>
                        </div>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md mb-4 mb-md-0">
                            ...
                            <ul
                                ...
                                <li><a class="list-group-item list-group-item-action" href="">Logiciel</a></li>
                                <li><a class="list-group-item list-group-item-action" href="">Fournitures de bureau</a>
                                </li>
                                <li><a class="list-group-item list-group-item-action" href="">Les composants
                                        de plaque solaire</a>
                                </li>
                        ...
                        <div class="col-12 col-md mb-4 mb-md-0">
                            ...
                            <ul class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
                                ...
                                <li><a class="list-group-item list-group-item-action" href="/login">Mon
                                        Compte</a></li>
                                <li><a class="list-group-item list-group-item-action" href="/">Accueil</a></li>
                                <li><a class="list-group-item list-group-item-action" href="/shop">Boutique</a></li>
