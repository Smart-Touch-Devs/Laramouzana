...
@section('subhead')
<title>Gestion de shop managers</title>
@endsection
                ...
                <div class="preview">
                    ...
                    <div class="overflow-x-auto">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border-b whitespace-no-wrap">
                                        <a href="javascript:;" style="width: fit-content; height: fit-content;" class="detailBtn" data-toggle="modal" data-target="#userDetails" data-detail_url="{{ route('users.showShopManager', $shopManager->id) }}">
                                    ...
                                    <td class="border-b whitespace-no-wrap">
                                        <a href="javascript:;" style="width: fit-content; height: fit-content;" class="deleteUserbtn" data-toggle="modal" data-target="#delete-modal-preview" data-delete_url="{{ route('users.deleteShopManager', $shopManager->id) }}">
                            ...
                            @else
                            <div class="rounded-md flex justify-between px-5 py-4 mb-2 bg-theme-17 text-theme-11 successAlert">
                                <div class="flex">
                                    <i data-feather="alert-triangle" class="w-6 h-6 mr-2"></i>
                                    <span>Aucun shop manager n'est actuellement membre</span>
                                </div>
                           </div>
                        @endif
                        </table>
    ...
    <div class="intro-y col-span-12 lg:col-span-5">
        <div class="intro-y box mt-5">
            ...
            <div class="p-5" id="responsive-table">
                ...
                @endif
                <form action="{{ route('users.addShopManager') }}" method="post">
                    @csrf
                    <div>
                        <label>Nom</label>
