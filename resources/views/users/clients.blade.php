                    ...
                    <div class="overflow-x-auto">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="border-b whitespace-no-wrap">{{ $client->lastname }}</td>
                                    <td class="border-b whitespace-no-wrap">{{ $client->firstname }}</td>
                                    <td class="border-b whitespace-no-wrap">{{ $client->email }}</td>
                                    <td class="border-b whitespace-no-wrap">{{ $client->phone }}</td>
                                    <td class="border-b whitespace-no-wrap">
                                        <a href="javascript:;" style="width: fit-content; height: fit-content;" class="detailBtn" data-toggle="modal" data-target="#userDetails" data-detail_url="{{ route('user.showClient', $client->id) }}">
                                    ...
                                    <td class="border-b whitespace-no-wrap">
                                        <a href="javascript:;" style="width: fit-content; height: fit-content;" class="deleteUserbtn" data-toggle="modal" data-target="#delete-modal-preview" data-delete_url="{{ route('users.delete_client', $client->id) }}">
                                ...
                                <div class="modal" id="delete-modal-preview">
                                    <div class="modal__content">
                                        ...
                                        <div class="px-5 pb-8 text-center">
                                             ...
                                             <a href="javascript:void()" id="confirmDeleteBtn"><button type="button" class="button w-24 bg-theme-6 text-white">Supprimer</button></a>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="intro-y col-span-12 lg:col-span-5">
        <div class="intro-y box mt-5">
            ...
            <div class="p-5" id="responsive-table">
                ...
                @endif
                <form action="{{ route('users.addClient') }}" method="post">
                    @csrf
                    <div>
                        <label>Nom</label>
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" name="sup_code" class="input w-full border mt-2" placeholder="Ex: Samed023">
                    </div>
                    <div class="mt-3">
